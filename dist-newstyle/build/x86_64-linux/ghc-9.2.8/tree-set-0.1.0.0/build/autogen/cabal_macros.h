...
/* package tree-set-0.1.0.0 */
#ifndef VERSION_tree_set
#define VERSION_tree_set "0.1.0.0"
#endif /* VERSION_tree_set */
#ifndef MIN_VERSION_tree_set
#define MIN_VERSION_tree_set(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tree_set */
...
#define CURRENT_PACKAGE_KEY "tree-set-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "tree-set-0.1.0.0-inplace"
